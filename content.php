...
<div class="container-fluid">
	<div class="container ss-grid-box-for-landing-pages">
		<div class="row">
            <?php
				// Custom query to retrieve success stories posts
				$args = array(
				   'post_type'      => 'any', // Retrieve all post types
    'posts_per_page' => -1,    // Display all posts
				);

				$success_stories_query = new WP_Query($args);

				// Start the loop
				if ($success_stories_query->have_posts()) :
				while ($success_stories_query->have_posts()) : $success_stories_query->the_post();
                ...
                $post_short_content = get_post_meta(get_the_ID(), 'post_short_content', true);
			?>
			<div class="col-lg-4 col-sm-12 col-md-4 single-grid-outer-block">
				<div class="recent-blog_box post_box">
	                ...
	                <div class="text-wrap related_text_wrap">
	                    ...
	                    <div class="post-excerpt-block"><p><?php echo $post_short_content; ?></p></div>
